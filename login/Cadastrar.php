...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["nomeUsuario"]))){
        ...
        $nomeUsuario_erro= "0 Nome do usuario não pode conter caracteres, numeros e sublinhados. Apenas letras.";
    }else{
        ...
        if ($stmt = $pdo ->prepare($sql)) {
            ...
            if ($stmt -> execute()) {
                ...
                if ($stmt -> rowCount () == 1) {
                  ...
                  $nome Usuario = trim($_POST["nomeUsuario"]);
                }
            }else{
...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css"
        integrity="sha384-MCw98/SENGEBEJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPk FOJwJ8ERdknLPMD" crossorigin="anonymous">
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="form-group">
                ...
                class="form-control <?php echo (!empty ($nomeUsuario_erro)) ? 'is-invalid':''; ?>" value="<?php echo $nomeUsuario?>">
...
class="form-control <?php echo (!empty($confirmarSenha_erro)) ? 'is-invalid': "; 2>" value="<?php echo $confirmarSenha: ?>">
<span class="invalid-feedback "X?php echo $confirmarSenha_erro; ?></span> </div>
<div class="form-group">
<input type="submit" class="btn btn-primary" value="Criar Conta">
<input type="reset" class="btn btn-danger ml-2" value="Apagar Dados"> </div>
