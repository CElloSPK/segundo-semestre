...
[22:05, 08/08/2024] SPK: label>Nome do usuário</label>

<input type="text" name="nomeUsuario"

class="form-control <?php echo (lempty(SnomeUsuario_erro)) ? 'is-invalid': ''; ?>"
...
<div class="form-group">
[22:06, 08/08/2024] SPK: <label>Senha</label>
