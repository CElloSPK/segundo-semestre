                        ...
                        if($stmt->rowCount() == 1){
                            if($row == $stmt->fetch()){
                                ...
                                if(password_verify($senha, $hashed_senha)){
                                    ...
                                    //A senha não é valida, exibe uma mensagem de erro genérica
                                    $login erro = "Nome de usuário ou senha inválidos.";
                                }
                            }
                        }else{
                            //O nome do usuário não existe, exibe uma mensagem de erro genérica
                            $login erro = "Nome de usuário ou senha inválidos.";
                        }
                    }else{
...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css"
        integrity="sha384-MCw98/SFnGE8fjT3gXwEOngsV7Zt27NXFoaoApmYm81uyXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
